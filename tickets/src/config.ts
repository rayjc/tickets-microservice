...
export const MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost:27017/tickets";
...
export const QUEUE_GROUP_NAME = process.env.QUEUE_GROUP_NAME || 'tickets-service';
